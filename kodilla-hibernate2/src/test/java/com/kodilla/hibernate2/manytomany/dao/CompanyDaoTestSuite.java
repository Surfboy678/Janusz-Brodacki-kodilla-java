...
public class CompanyDaoTestSuite {
    ...
    public void testRetrieveEmployeeByLastname() {
        ...
        //When
        List<Employee> employeeLastname = employeeDao.retrieveEmployeeWithLastName("Smith");

        //Then
        try {
            Assert.assertNotEquals(1, employeeLastname.size());
        } finally {
            //CleanUp
    ...
    public void testRetrieveCompanyByName() {
        ...
        //When
        List<Company> companyName = companyDao.retrieveCompanyWhoseNameBegins("CORP");

        //Then
        try {
            Assert.assertEquals(0, companyName.size());
        } finally {
            //CleanUp
